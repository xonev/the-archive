(defproject websites "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "websites.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main websites.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "websites.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/websites.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main websites.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main websites.system
                           :output-to "resources/public/js/compiled/websites.js"
                           :output-dir "target"
                           :source-map-timestamp true
