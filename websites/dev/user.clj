(ns user
  (:require [websites.application]
            ...
            [websites.components.shell-component :refer [shell-component]]
            [websites.config :refer [config]]))

(defn dev-system []
  (let [config (config)]
    (assoc (websites.application/app-system config)
